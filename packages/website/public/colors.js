...
document.addEventListener("DOMContentLoaded", () => {
    !function(){try{var e,v,o=document,c=o.cookie,k=`; ${c}`.split("; color=");if(2===k.length&&(e=k.pop().split(";").shift())){v=JSON.parse(e);if(typeof v==="string"&&v.length===7&&!isNaN(Number("0x"+v.substring(1)))){window.UED_COLOR=v;ued.setPropFromColor(v);}}}catch(_){}}()
});
